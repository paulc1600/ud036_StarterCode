...
def find_movies():
    # Load Movies into array from csv file if it exists,
    #  otherwise create csv if it does not exist
    ...
    if (nbrmov == 6):
        ...
        movies = [jesus, toy_story, avatar, endersgame,
                  school_of_rock, avengers]
        # Create page and display in browser
